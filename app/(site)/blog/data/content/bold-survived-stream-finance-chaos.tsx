  ...
  return (
    <>
      <p>
        ...
        <a href="https://coinmarketcap.com/currencies/liquity-v2/" target="_blank" rel="noopener noreferrer">
      ...
      <p>
        ...
        market pressure, and confirm liquidations execute instantly without external dependencies. This transparency
        lets users investigate BOLD's collateral isolation, observe redemption-based stability through immutable
        contracts, and verify there are no external fund managers or off-chain operations.
      </p>
