  ...
  return (
    <>
      ...
      <p>
        ...
        lacking blockchain data or analytic capabilities. We're lacking the translation layer between protocol semantics
      ...
      <p>
        ...
        users directly controlling their financial interactions. But users are increasingly relying on managed services
        to navigate the ecosystem. We're building a better financial system but recreating the same dependency
      ...
      <p>
        <strong>Protocols bear support costs too.</strong> <i>"What happened to my transaction?"</i> becomes a constant
        support burden. It may be impossible to quantify the users who abandon attempts at using DeFi out of confusion,
        not dissatisfaction with protocol functionality.
      </p>
      ...
      <p>
        ...
        aims to bridge this gap, providing a <em>user-focused </em>analytics platform that provides independent
        interpretation of your protocol activity. Maintaining the same credible neutrality as other ecosystem tools. It
        takes complex blockchain data and transforms it into clear, actionable insights and rich, detailed explanations
        of your specific transactions without requiring a wallet connection or private keys. By providing this
        transaction-level explanation, Rails naturally becomes self-service support infrastructure for DeFi.
      </p>
