export default function WhenFrontendsFailWhatHappensInACrisis() {
  return (
    <>
      <p>
        The recent Aerodrome Finance and Velodrome Finance DNS incident reminds us again of a familiar problem. Users
        have a patchwork of tools to turn to in a crisis, but nothing that lets them check their positions with
        confidence.
      </p>
      ...
      <p>
        ...
        provides the solution: an independent, read-only platform for safely checking your positions when frontends
        fail.
      </p>
      <h2>The 3:24 AM Panic Scenario</h2>

      <p>It's early. Your phone is buzzing with notifications. Someone has tagged @everyone in a protocol's Discord.</p>
      ...
      <p>
        Frontend failures also put pressure on teams, with moderators quickly overwhelmed. Providing a personalised
        breakdown to every user seeking help becomes a challenge.
      </p>
      ...
      <p>
        DeFi needs a service during moments of stress that is <strong>Read‑only and safe</strong> in high‑risk
        situations, <strong>Usable by non‑technical users</strong>, and <strong>Independent</strong> of protocol
        frontends.
      </p>
