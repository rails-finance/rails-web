  ...
  return (
    <div className="container mx-auto md:px-6 px-4 pt-32 pb-12 max-w-6xl">
      <div className="prose prose-lg max-w-none text-slate-800">
        <h1 className="text-3xl font-bold text-slate-700 mb-6">How Rails Works</h1>
        ...
        {activeTab === "overview" ? (
          <>
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">What Rails Does</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">The Rails Approach</h2>

              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">1. Data Collection</h3>
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">2. Context Enrichment</h3>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">3. Processing & Analysis</h3>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">4. User-Friendly Display</h3>
                  <p className="text-slate-600 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Why Rails is Different</h2>

              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Complete Transaction Context</h3>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Protocol-Specific Intelligence</h3>
                  <p className="text-slate-600 text-sm">
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Real-Time Processing</h3>
                  <p className="text-slate-600 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Security & Privacy</h2>
          ...
          <>
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Technical Architecture</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">System Components</h2>

              <div className="space-y-6">
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">1. Blockchain Indexer (Ponder)</h3>
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">2. Message Queue (RabbitMQ)</h3>
                  <p className="text-slate-600 mb-3">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">3. Event Processors</h3>
                  <p className="text-slate-600 mb-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-4">
                    <div className="border-l-4 border-blue-400 pl-3">
                      <h4 className="font-medium text-slate-700">Ownership Processor</h4>
                    ...
                    <div className="border-l-4 border-green-400 pl-3">
                      <h4 className="font-medium text-slate-700">Transaction Processor</h4>
                      <ul className="text-xs text-slate-600 mt-1">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">4. Database Layer (PostgreSQL)</h3>
                  <p className="text-slate-600 mb-3">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">5. API Gateway</h3>
                  <p className="text-slate-600 mb-3">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  <h3 className="text-lg font-semibold text-slate-700 mb-3">6. Frontend (Next.js + React)</h3>
                  <p className="text-slate-600 mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Data Flow Example</h2>
              <div className="bg-blue-50 rounded-lg p-5">
                <h3 className="text-lg font-semibold text-blue-800 mb-3">When a user opens a trove:</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Key Innovations</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Transaction Receipt Analysis</h3>
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Pre-computed Summaries</h3>
                  <p className="text-sm text-slate-600">
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Event Correlation</h3>
                  <p className="text-sm text-slate-600">
                ...
                <div className="border rounded-lg p-4">
                  <h3 className="font-semibold text-slate-700 mb-2">Protocol-Aware Processing</h3>
                  <p className="text-sm text-slate-600">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-600 mb-4">Open Source</h2>
              <p className="text-slate-700 mb-4">
                Rails is committed to transparency. Our codebase is open source and available for review:
              </p>
              <div className="bg-green-50 rounded-lg p-4">
                <a href="https://github.com/rails-finance" className="text-green-700 hover:text-green-800 font-medium">
