...
<div className="rounded-lg p-5 border-2 border-green-600 mb-2 lg:mb-0 lg:h-full lg:flex lg:flex-col">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center">
                ...
                <h4 className="text-lg font-semibold text-slate-600">Liquity V2 Support</h4>
              </div>
...
<div className="rounded-lg p-5 border-2 border-blue-600 lg:mt-2 lg:h-full lg:flex lg:flex-col">
      	     <div className="flex items-start justify-between mb-3">
      	       <div className="flex items-center">
      	         ...
      	         <h4 className="text-lg font-semibold text-slate-600">Ecosystem Expansion</h4>
      	       </div>
...
<div className="bg-slate-50 rounded-lg p-5 mb-2 lg:mb-0 lg:h-full lg:flex lg:flex-col">
      	      <div className="flex items-start justify-between mb-3">
      	        <div className="flex items-center">
      	          <div className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center mr-3">
      	            <span className="text-white font-bold">3</span>
      	          </div>
      	          <h4 className="text-lg font-semibold text-slate-600">Multi-Protocol Intelligence</h4>
      	        </div>
...
<div className="bg-slate-50 rounded-lg p-5 lg:mt-2 lg:h-full lg:flex lg:flex-col ">
          	      <div className="flex items-start justify-between mb-3">
          	        <div className="flex items-center">
          	          <div className="w-10 h-10 bg-orange-400 rounded-full flex items-center justify-center mr-3">
          	            <span className="text-white font-bold">4</span>
          	          </div>
          	          <h4 className="text-lg font-semibold text-slate-600">Modularisation</h4>
          	        </div>
          	        <span className="text-xs font-extrabold text-slate-100 bg-slate-400 px-2 py-1 rounded-full">Planned</span>
          	      </div>
          	      <p className="text-sm text-slate-600 ml-13">
...
{/* Team Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold mb-6 text-slate-600">Team</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8  mb-8">
            <div className="bg-slate-50 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-semibold text-slate-600">Miles Essex</h3>
                  <p className="text-slate-600">Designer</p>
                  <a href="https://x.com/milesessex" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700">@milesessex</a>
                </div>
              </div>
           ...
           {/* Slava */}
            <div className="bg-slate-50 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-semibold text-slate-600">Slava</h3>
                  <p className="text-slate-600">Developer</p>
                  <a href="https://x.com/slvdev" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700">@slvdev</a>
                </div>
              </div>
              <p className="text-slate-700">
        ...
        {/* Supporters Section */}
          ...
          <h2 className="text-3xl font-semibold mb-6 text-slate-600">Our Supporters</h2>
          <div className="bg-slate-50 rounded-lg p-6">
            <div className="flex items-start">
              ...
              <div className="ml-6 flex flex-col items-center rounded-xl bg-green-500 p-8">
        ...
        {/* Contact Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold mb-6 text-slate-600">Connect With Us</h2>

          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="bg-slate-50 rounded-lg p-6 shadow hover:lg:shadow-lg">
              <h3 className="text-xl font-semibold text-slate-600 mb-4">General Inquiries</h3>
            ...
            <div className="bg-slate-50 rounded-lg p-6 shadow hover:lg:shadow-lg">
              <h3 className="text-xl font-semibold text-slate-600 mb-4">Our code</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                  <div className="w-5 h-5 mr-3 text-green-600"></div>
            ...
            <div className="bg-fuchsia-400 rounded-lg p-6 shadow hover:lg:shadow-lg">
              <h3 className="text-xl font-extrabold text-white mb-4">Support Rails</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                  <a href="https://etherscan.io/name-lookup-search?id=donate.rails.eth" className=" rounded-full bg-fuchsia-600 hover:bg-fuchsia-700/50 transition-all duration-300 p-2 px-4 text-3xl font-extrabold text-white  hover:text-white" target="_blank">
