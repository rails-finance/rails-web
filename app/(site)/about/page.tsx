            ...
            <div className="bg-slate-50 rounded-lg p-6 shadow hover:lg:shadow-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <div className="w-5 h-5 mr-3 text-green-600"></div>
                  <a
                    href="https://github.com/rails-defi/rails"
                    className="text-blue-600 hover:text-blue-700"
                    target="_blank"
                  >
                    GitHub
                ...
                <p className="text-slate-600 text-sm">Help us continue building tools for the DeFi community</p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <a
                    ...
                    className=" rounded-full bg-fuchsia-600 hover:bg-fuchsia-700/50 transition-all duration-300 p-2 px-4 text-3xl font-extrabold text-white  hover:text-white"
                    target="_blank"
                  >
