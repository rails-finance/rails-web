    ...
    <div className="container mx-auto md:px-6 px-4 pt-32 pb-12 max-w-3xl">
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-rb-500 mb-4">
            We do not use tracking cookies or advertising cookies. We use Vercel Analytics, a cookieless,
            privacy-friendly service that records aggregate page views without storing data on your device or building
            cross-site profiles. All local storage data can be cleared through your browser settings.
          </p>
        </section>
