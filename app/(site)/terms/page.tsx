  ...
  return (
    <div className="container mx-auto md:px-6 px-4 pt-32 pb-12 max-w-4xl">
      <div className="prose prose-lg max-w-none text-slate-800">
        <h1 className="text-3xl font-bold text-slate-700 mb-2">Terms of Service</h1>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">2. Description of Service</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">3. No Financial Advice</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">4. DeFi and Blockchain Risks</h2>
          <p className="text-slate-700 mb-4">You acknowledge and understand that:</p>
          <ul className="list-disc pl-6 mb-4 text-slate-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">5. Acceptable Use</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">6. Intellectual Property</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">7. Disclaimer of Warranties</h2>
          <p className="text-slate-700 mb-4 font-semibold">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">8. Limitation of Liability</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">9. Indemnification</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">10. Third-Party Services</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">11. Modifications</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">12. Termination</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">13. Governing Law</h2>
          <p className="text-slate-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-slate-600 mb-4">14. Contact Information</h2>
          <p className="text-slate-700 mb-4">
