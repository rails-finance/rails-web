...
// position page's own `opengraph-image.tsx` reads (`loadAaveV3BaseTail`,
...
export const alt = "This event's immutable Aave V3 on Base share card";
...
export default async function Image({ params }: Props) {
  ...
  return eventImage({
    ...
    load: async () => {
      ...
      return eventCardModel(event, { session: "aave-v3-base", subject: shortSubject(wallet) });
    },
  });
}
