...
export default function AlchemixPositionNotFound() {
  return (
    ...
    >
      An Alchemix position is keyed by both. The line names which synthetic on which chain holds it, the alUSDb line
      here, and an id that exists on one line is a different position on another.
    </RouteNotFound>
  );
}
