...
// One Transmuter position on Base. Both explorers run the same route body
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return transmuterPositionMetadata(ALCHEMIX_BASE, await params);
}

export default async function BaseTransmuterPositionPage({ params }: Props) {
  return <TransmuterPositionPage deployment={ALCHEMIX_BASE} params={await params} />;
}
