...
import { morphoBaseMarketShareCardModel } from "@/lib/morpho-base/share-card";
...
export const alt = "This position's live Morpho Blue on Base position card";
...
export default async function Image({ params }: Props) {
  ...
  return positionImage({
    ...
    load: async () => {
      ...
      return morphoBaseMarketShareCardModel(tail.head, wallet, market);
    },
  });
}
