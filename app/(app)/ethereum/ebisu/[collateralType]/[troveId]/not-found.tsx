// The 404 body for a trove Ebisu does not hold. The status comes from the
...
export default function EbisuTroveNotFound() {
  return (
    <RouteNotFound
      session="ebisu"
      heading="No trove under this branch and id"
      backHref="/ethereum/ebisu"
      backLabel="Browse Ebisu troves"
    >
