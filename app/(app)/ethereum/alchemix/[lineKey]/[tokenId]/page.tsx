...
// One Alchemist position on Ethereum. Both explorers run the same route body
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return alchemixPositionMetadata(ALCHEMIX_ETHEREUM, await params);
}

export default async function EthereumAlchemixPositionPage({ params }: Props) {
  return <AlchemixPositionPage deployment={ALCHEMIX_ETHEREUM} params={await params} />;
}
