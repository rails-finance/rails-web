...
// `loadMoonwellPositionTail`, the exact same server read the page itself
...
import { moonwellShareCardModel } from "@/lib/moonwell/share-card";
...
export const alt = "This account's live Moonwell position card";
...
export default async function Image({ params }: Props) {
  ...
  return positionImage({
    ...
    load: async () => {
      ...
      return moonwellShareCardModel(tail.position, wallet);
    },
  });
}
