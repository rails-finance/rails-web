...
// position page's own `opengraph-image.tsx` reads (`loadMoonwellPositionTail`,
...
export const alt = "This event's immutable Moonwell share card";
...
export default async function Image({ params }: Props) {
  ...
  return eventImage({
    ...
    load: async () => {
      ...
      return eventCardModel(event, { session: "moonwell", subject: shortSubject(wallet) });
    },
  });
}
