...
// position page's own `opengraph-image.tsx` reads (`loadCompoundV2PositionTail`,
...
export const alt = "This event's immutable Compound V2 share card";
...
export default async function Image({ params }: Props) {
  ...
  return eventImage({
    ...
    load: async () => {
      ...
      return eventCardModel(event, { session: "compound-v2", subject: shortSubject(wallet) });
    },
  });
}
