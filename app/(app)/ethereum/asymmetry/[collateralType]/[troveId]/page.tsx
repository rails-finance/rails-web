...
import AsymmetryTroveDetail from "./trove-view";
...
export async function generateMetadata({
  ...
  return positionMetadata({
    ...
    canonicalPath: `/ethereum/asymmetry/${collateralType}/${troveId}`,
...
export default async function AsymmetryTrovePage({ params }: Props) {
  const { collateralType, troveId } = await params;
