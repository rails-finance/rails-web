// The trove's live share card — a second consumer of `loadAsymmetryTroveTail`,
...
import { asymmetryShareCardModel } from "@/lib/asymmetry/share-card";
...
export const alt = "This trove's live Asymmetry position card";
...
export default async function Image({ params }: Props) {
  ...
  return positionImage({
    ...
    load: async () => {
      ...
      return asymmetryShareCardModel(tail, { collateralType, troveId });
    },
  });
}
