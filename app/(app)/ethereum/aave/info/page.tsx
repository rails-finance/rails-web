// The explorer's about page — /ethereum/aave/info, the (i) in the rail.
// ----------------------------------------------------------------------------
...
// rather than a second copy of it — 0028 gives a page one address.
//
...
export default function AaveVaultsInfoRedirect() {
  redirect(`${protocolForHref("/ethereum/aave")!.subPages[0].href}/info`);
}
