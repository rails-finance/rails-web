...
export function LiquidatedListingCard({ trove, collateralAtLiquidation, hideLabels = false }: { trove: TroveSummary; collateralAtLiquidation?: number; hideLabels?: boolean }) {
