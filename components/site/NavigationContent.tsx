...
export function NavigationContent({ onLinkClick }: NavigationContentProps) {
  ...
  return (
    <>
      <div className="space-y-3">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <div className={`flex ${item.iconBg} text-white p-2 rounded ${
                isActive ? 'opacity-60' : ''
              }`}>
                {item.icon}
              </div>
      ...
      <div className="space-y-3">
        <div className="text-xs text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-3">
          Connect With Us
        </div>
        <div className="flex items-center gap-4">
          <a
            ...
            className="text-blue-500 dark:text-blue-400 hover:text-green-600 dark:hover:text-green-400 transition-colors"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-red-500 dark:text-red-400 hover:text-green-600 dark:hover:text-green-400 transition-colors"
