    ...
    <>
      <div className="space-y-4">
        {pathname !== '/' && (
          <Link
            href="/"
            className="flex items-center gap-2 text-lg font-medium text-slate-900 hover:text-green-600 py-2 transition-colors"
            onClick={onLinkClick}
          ><div className="flex bg-slate-200 py-1.5 px-2 rounded">
            <Home size={20} />
</div>
            <span>Home</span>
          </Link>
        ...
        {pathname !== '/about' && (
          <Link
            href="/about"
            className="flex items-center gap-1 text-lg font-medium text-slate-900 hover:text-green-600 py-2 transition-colors"
            onClick={onLinkClick}
          ><div className="flex bg-slate-200 py-1.5 px-0.5 rounded">
            <User size={20} />
