export const IconSymbols = () => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }} aria-hidden="true">
    ...
    <symbol id="icon-trove-transfer" viewBox="0 0 24 24">
      <path
        d="M 21 13.234 L 21 5 C 21 3.895 20.105 3 19 3 L 5 3 C 3.895 3 3 3.895 3 5 L 3 19 C 3 20.105 3.895 21 5 21 L 9.706 21"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
      ...
      <path
        d="M 21 13.298 L 17.914 10.914 C 17.133 10.133 15.867 10.133 15.086 10.914 L 6 21"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
