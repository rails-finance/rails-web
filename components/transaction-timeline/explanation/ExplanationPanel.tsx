    ...
    >
      {!shouldShowOpen ? (
        <button
          ...
          className="cursor-pointer px-4.5 flex items-center gap-1 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors duration-150"
        ...
        <div className="">
          <button
            onClick={handleToggle}
            className="cursor-pointer w-full px-4.5 flex items-center justify-between gap-1 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors duration-150"
            aria-expanded={shouldShowOpen}
            aria-label="Show transaction details"
          >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1 text-xs  text-slate-700 dark:text-slate-600">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-1 py-1 hover:text-green-500 transition-colors duration-150"
          ...
          <button
            onClick={handleToggle}
            className="cursor-pointer w-full py-1 flex items-center justify-center gap-1 text-slate-600 dark:text-slate-600 hover:text-slate-900 dark:hover:text-slate-300 transition-colors duration-150"
            aria-expanded={shouldShowOpen}
