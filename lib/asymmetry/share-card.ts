// Asymmetry Trove → share-card model. The bridge between
// `loadAsymmetryTroveTail` (the same server tail the trove page itself
...
import { DEBT_SYMBOL, shortId } from "@/lib/asymmetry/asset-catalog";
...
const STATUS_WORD: Record<AsymmetryTroveSummary["status"], string> = {
  open: "Open",
  closed: "Closed",
  liquidated: "Liquidated",
};

export function asymmetryShareCardModel(
  tail: ForkTroveTail<AsymmetryTroveSummary>,
